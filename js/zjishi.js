var now = new Date();
        function createtime() {
            var grt = new Date("10/28/2022 23:27:00");//修改时间
            // var grt = new Date("10/22/2022 00:06:00");
            ...
            if (String(snum).length == 1) { snum = "0" + snum; } document.getElementById("timeDate").innerHTML = "久久和六宝已经互关认识 " + dnum + " 天";
